                ...
                <div class="image-zoom-container">
                    <div class="image-zoom-item">
                        <div class="image-zoom-limit">
                            <img class="image-zoom" src="{{ asset('images/specialists.jpg') }}" alt="Laravel Specialists    ">
                        </div>
                        <h2 class="image-zoom-title">Laravel</h2>
                        <p class="image-zoom-text">
                            Na Pure Code IT, somos especialistas em Laravel, criando soluções personalizadas que atendem aos objetivos do seu negócio com inovação e escalabilidade.                        </p>
                    ...
                    <div class="image-zoom-item">
                        ...
                        <p class="image-zoom-text">
                            A metodologia ágil aliada ao Laravel permite entregas rápidas, adaptáveis e com máxima qualidade. Fique à frente com soluções que evoluem conforme suas necessidades!
                        </p>
                        <button class="image-zoom-button">
                    ...
                    <div class="image-zoom-item">
                        ...
                        <p class="image-zoom-text">
                            Oferecemos suporte contínuo para garantir que seus sistemas Laravel estejam sempre atualizados e funcionando perfeitamente, sem surpresas ou quedas de desempenho.
                        </p>
                        <button class="image-zoom-button">
            ...
            <div class="choose-us-content">
                ...
                <div class="choose-us-item">
                    ...
                    <div class="choose-text-content">
                        ...
                        <p class="choose-item-description">Com nossa especialização em Laravel, criamos soluções personalizadas que crescem junto com seu negócio, garantindo máxima escalabilidade e eficiência.</p>
                    </div>
                </div>
                ...
                <div class="choose-us-item">
                    ...
                    <div class="choose-text-content">
                        ...
                        <p class="choose-item-description">Entregamos resultados rápidos e precisos, adaptando-nos às necessidades do seu projeto, com a flexibilidade que a metodologia ágil proporciona.</p>
                    </div>
                </div>
                ...
                <div class="choose-us-item">
                    ...
                    <div class="choose-text-content">
                        ...
                        <p class="choose-item-description">Nosso suporte contínuo assegura que seu sistema esteja sempre no seu melhor desempenho, com atualizações regulares e assistência proativa.</p>
                    </div>
                </div>
            </div>
        </div>
